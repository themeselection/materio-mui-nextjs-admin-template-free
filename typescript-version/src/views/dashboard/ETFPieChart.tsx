...
const ETFPieChart: React.FC<ETFPieChartProps> = ({ series, labels }) => {
  ...
  if (loc_series === undefined) setSeries(series === undefined ? getRandomValues(3) : series)

  if (loc_labels === undefined) setLabels(labels === undefined ? ['Commodities', 'Cash', 'Equities'] : labels)
